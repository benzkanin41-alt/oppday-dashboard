...
def main() -> int:
    ...
    add_source_once(payload, {'name': 'FRED U.S. Treasury 2Y/5Y/10Y/30Y constant maturity yields', 'url': 'https://fred.stlouisfed.org/categories/115', 'publication_date': 'Historical series; latest observation date is shown in the curve', 'used_for': 'U.S. 2Y, 5Y, 10Y, and 30Y Treasury yield curve chart and latest rates.'})
    add_source_once(payload, {'name': 'SET Index overview', 'url': 'https://www.set.or.th/en/market/index/set/overview', 'publication_date': 'SET exchange snapshot; observation date is shown beside the value', 'used_for': 'SET Index latest value and daily change snapshot.'})
    add_source_once(payload, {'name': 'SET mai Index overview', 'url': 'https://www.set.or.th/en/market/index/mai/overview', 'publication_date': 'SET exchange snapshot; observation date is shown beside the value', 'used_for': 'mai Index latest value and daily change snapshot.'})
    add_source_once(payload, {'name': 'ThaiBMA Government Bond Yield Curve', 'url': 'https://www.thaibma.or.th/EN/Market/YieldCurve/Government.aspx', 'publication_date': 'Historical series; latest observation date is shown in the curve', 'used_for': 'Thailand government bond 2Y, 5Y, 10Y, and 30Y yield curve chart and latest rates.'})
